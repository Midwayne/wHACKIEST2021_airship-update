...
void infected_record(long long int infected_number)
{	
...
if(d.getphone()!=infected_number){
	...
	else if(d.get_entry_hour() <= inf_exit_hour && d.get_entry_hour() >= inf_entry_hour && d.get_entry_min() <= inf_exit_min && d.get_entry_min() >= inf_entry_min && d.get_entry_sec() <= inf_exit_sec && d.get_entry_sec() >= inf_entry_sec)		 	
		 {
